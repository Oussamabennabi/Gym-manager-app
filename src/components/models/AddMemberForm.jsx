    ...
    <Box >
      ...
      <FormGroup >
        <Stack gap={3} direction={"row"}>
          ...
          <Stack flex={.7} mt={"1.1rem"} >
        <PhotoPicker value={photo} onChange={setPhoto} />
              <Button onClick={()=>setShowCamera(true)} sx={{ textTransform: "none", fontWeight: "bold",my:"1rem",mt:"1.8rem" }} variant={"contained"}>Take a photo <CameraAltIcon sx={{ml:"10px"}} /></Button>
              <DefaultModal
                open={showCamera}
              ...
              >
                ...
                <Camera value={ photo} onCapture={setPhoto} />
              </DefaultModal>
        <CustomInput
          value={fullName}
...
<FormControl sx={{ my: "1rem" }} fullWidth>
          ...
          >
            <MenuItem value={membershipsPlans.oneMonth}>One Month</MenuItem>
            <MenuItem value={membershipsPlans.twoMonth}>Two Months</MenuItem>
          </Select>
        </FormControl>
        ...
        <CustomInput
          ...
          startAdornment={<InputAdornment position="start">DZ</InputAdornment>}
          label={"Paid"}
        />
...
function Camera({value,onCapture}) {
